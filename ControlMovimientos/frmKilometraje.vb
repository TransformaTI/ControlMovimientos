...
#End Region
    ...
    Private Sub ConsultaCamion()
        ...
        Else
            oCamion.CargarDatos(CType(txtCamion.Text, Integer), strURLGateway, CByte(GLOBAL_Modulo.ToString()), SigaMetClasses.DataLayer.Conexion.ConnectionString, GLOBAL_Empresa)
        End If
