...
'Identificador de cambios: 20051229CAGP$003

'Modifico: Claudia Aurora Garcia Patiño
'Fecha: 19/05/2006
'Motivo: Al momento de registrar un resguardo al Tanque de almacenamiento, no debe de pedir porcentajes
'inicial y final, debido a que por el monto de entrada es muy minima la variación de porcentajes
'Identificador de cambios: 20060519CAGP$001
...
' Identificador de cambios: 20060617CAGP$009
...
' Registra le trasiego realizado a un cliente especifico, un trasiego puede ser realizado por un camion portatil
' o un autotanque
Public Class frmMovimientoResguardoEntrada
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmMovimientoResguardoEntrada))
        ...
        'grpDatos
        '
        Me.grpDatos.Controls.AddRange(New System.Windows.Forms.Control() {Me.btnBuscar, Me.Label4, Me.cboCamion, Me.cboCorporativo, Me.Label2, Me.Label10, Me.lblLitros, Me.ProductoPanel, Me.txtCliente, Me.lblRuta, Me.cboAlmacen, Me.Label12, Me.Label13, Me.Label6, Me.Label5, Me.lblEmpresa, Me.Label1, Me.dtpFMovimiento, Me.lblCliente, Me.Label3, Me.Label7, Me.dtpFResguardo})
        ...
        Me.btnBuscar.Location = New System.Drawing.Point(406, 106)
        ...
        Me.Label10.Location = New System.Drawing.Point(308, 384)
        ...
        Me.lblLitros.Location = New System.Drawing.Point(358, 379)
        ...
        Me.ProductoPanel.Size = New System.Drawing.Size(472, 90)
        ...
        Me.Name = "frmMovimientoResguardoEntrada"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Entrada de gas por resguardo"
...
#End Region
    ...
    Function MedicionFisica() As Boolean
        ...
        '    frmCapturaMedicionTanque.Text = "Lecturas físicas de gas por movimiento - [" + cboAlmacen.Text + "]"
        '    frmCapturaMedicionTanque.InicializaForma(0, cboAlmacen.Identificador, 0, GLOBAL_Usuario, GLOBAL_IDEmpleado, False, dtpFMovimiento.Value)
    ...
    Private Sub RealizarMovimientos()
        ...
        If Result = DialogResult.Yes Then
            ...
            oFolioMovimientoAlmacen.Registrar(0, cboAlmacen.Identificador, 0, 8, 0)

            Dim oMovimientoAlmacenE As New PortatilClasses.Consulta.cMovimientoAlmacen(0, 0, cboAlmacen.Identificador, _
                                           FechaMov, Kilos, Litros, 8, dtpFResguardo.Value, oFolioMovimientoAlmacen.NDocumento, _
    ...
    Private Sub frmMovimientoTrasiego_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Cursor = Cursors.WaitCursor
        ...
        If cboAlmacen.Text <> "" Then
            ...
            If cboAlmacen.Movil = False Then
                ' Muestra los camiones de portatil
                cboCamion.CargaDatos(2, GLOBAL_Usuario)
            Else
                ' Muestra los auto.tanques
                cboCamion.CargaDatos(0, GLOBAL_Usuario)
            End If
        End If
        DatosSalvados = False
        Cursor = Cursors.Default
